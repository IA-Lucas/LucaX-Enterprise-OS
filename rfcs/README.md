...
| [**RFC-0038**](RFC-0038-framework-de-execucao-e-avaliacao.md) | **Admissao do Execution & Evaluation Framework** — o tipo `Evaluation` segue recusado *(reabrir e `C3` do Soberano — `AE-1`)*; a pratica vira contrato sem inventar tipo | **aprovado** | [ADR-0043](../decisions/ADR-0043-framework-de-execucao-e-avaliacao.md) |
