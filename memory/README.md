...
| APR | **6** | [MEM-APR-0001](aprendizado/MEM-APR-0001-ratificacao-por-precedente.md) — ressalva escrita nao neutraliza condicao de validade · [MEM-APR-0002](aprendizado/MEM-APR-0002-duplicacao-por-reproducao-de-tabela.md) — detectar duplicacao nao previne duplicacao · [MEM-APR-0003](aprendizado/MEM-APR-0003-campo-de-estado-em-artefato-imutavel.md) — campo de estado em artefato imutavel · [MEM-APR-0004](aprendizado/MEM-APR-0004-projecao-revela-divergencia-antiga.md) — projecao revela divergencia antiga · [MEM-APR-0005](aprendizado/MEM-APR-0005-medir-a-ausencia-na-fonte-errada.md) — buscar o termo em vez da funcao produz achado de lacuna onde ha titular declarado · [**MEM-APR-0006**](aprendizado/MEM-APR-0006-exercer-o-contador-revela-o-defeito.md) — **exercer o instrumento revela o defeito que ler o instrumento nao revela** |
